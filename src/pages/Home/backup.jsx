  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <br />
        This feature allows you to assess the current crowd level in the
        canteen.
        <ul>
          <li>Very Crowded</li>
          <li>Normal</li>
        ...
        <u>Queue Advisory</u>
        <br />
        <img src={Warning} alt="imported" />
        <br />
        This indicator notifies users about potentially long queues at a
        particular stall.
        <br />
        <img src={Closed} alt="imported" />
        <br />
        ...
        <br />
        <img src={RefreshQueue} alt="imported" />
        <br />
        To get the latest stall queue information, simply click the refresh
        button.
      </DialogContent>
    </Dialog>
  );
